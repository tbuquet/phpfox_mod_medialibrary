...
/**
* Class that processes the loading of the block "genres"
*
...
* @version	1.0
*/
class Medialibrary_Component_Block_Genres extends Phpfox_Component 
{ 
	/**
	* Load the required information for the bloc "genres"
	*/
